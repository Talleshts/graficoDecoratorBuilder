...
public abstract class GraficoBuilder {
    ...
    public final void criaDados(Map<String, Double> dadosListados) {
        ArrayList<String> categorias = new ArrayList<>(dadosListados.keySet());

        for (int i = 0; i < categorias.size(); i++) {
            dataset.addValue(dadosListados.get(categorias.get(i)), categorias.get(i).split(",")[0], categorias.get(i).split(",")[1]);
        }
    }
